...
public class ReflectionUtils {
    ...
    public static void invokeMethod(Context context, Application application, String methodName) throws Exception {
        if (android.os.Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
            Application.class
                    .getMethod(methodName, Class.forName("android.content.ComponentCallbacks"))
